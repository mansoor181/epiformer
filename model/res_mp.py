...
class MultiRelationalEGNNLayer(nn.Module):
    ...
    def forward(self, h, x, hetero_data, node_type):
        ...
        # Iterate over all 4 graph relation types (r0-r3); when num_relations < 4,
        # route edges through MLP "rel % num_relations" to share weights.
        for rel in range(4):  # Graph always has r0-r3
            ...
            # Compute messages: m_ij^(r) — map to available MLP via modulo
